package org.whut.webservice.common.security.web;
...
import org.whut.webservice.common.config.CommonConfigProvider;
import org.whut.webservice.common.security.UserContext;
import org.whut.webservice.common.security.entity.SubUser;
import org.whut.webservice.common.security.entity.User;
import org.whut.webservice.common.security.entity.UserAuthority;
import org.whut.webservice.common.security.service.AppService;
import org.whut.webservice.common.security.service.AuthorityService;
...
import org.whut.webservice.common.util.json.JsonMapper;
import org.whut.webservice.common.util.json.JsonResultUtils;
...
public class UserServiceWeb {
    ...
    private static Logger logger = LoggerFactory.getLogger(UserServiceWeb.class);
    ...
    public String selfUploadImage(@Context HttpServletRequest request){
        ...
        //获得用户图片路径
        String userImgRootPath = CommonConfigProvider.get("user.img.root.path") ;
        String userImgRelativePath =  CommonConfigProvider.get("user.img.relative.path") ;
        String userName = UserContext.currentUserName();
