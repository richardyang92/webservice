...
import org.whut.webservice.common.security.entity.*;
import org.whut.webservice.common.security.service.*;
...
public class AuthorityServiceWeb {
    ...
    private static Logger logger = LoggerFactory.getLogger(AuthorityServiceWeb.class);
